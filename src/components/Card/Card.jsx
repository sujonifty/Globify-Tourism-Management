            ...
            <div className="max-w-xs rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-2">
                        ...
                        <NavLink to={`/delete/${_id}`}><button type="button" className=" btn flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50">Delete</button></NavLink>
