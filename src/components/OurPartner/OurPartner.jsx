                        ...
                        <div>
                            <fieldset className="w-full space-y-1 dark:text-gray-800">
                                ...
                                <label className="input input-bordered flex items-center gap-2">
                                    ...
                                    <span><button className="bg-[#D2B48C] hidden md:flex btn -mr-4 text-white font-bold">Subscribe Now</button></span>
                                </label>
                                <button className="bg-[#D2B48C] md:hidden btn -mr-4 text-white font-bold">Subscribe Now</button>
