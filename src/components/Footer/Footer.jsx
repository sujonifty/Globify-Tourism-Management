...
const Footer = () => {
    return (
        <div>
            <footer className="mt-20 border-t-2 px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <div className="w-2/3">
                            <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center p-1">
                                <img src="https://i.ibb.co/d0P6T0M/footer-logo.png" alt="" />
                            </a>
                        </div>
                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase dark:text-gray-900">Book by Phone</h3>
                            <div className="flex justify-start items-center">
                                <FaPhone />
                                <p>+8801756501014</p>
                            </div>
                            <p>Booking: 9.00am-11.30pm</p>
                        </div>
                        <div className="space-y-3">
